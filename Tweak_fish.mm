...
//%ctor {
    @autoreleasepool {     
        ...
        rebind_symbols((struct rebinding[1]){{"xpc_connection_create",(void *)new_xpc_connection_create, (void **)&orig_xpc_connection_create}},1);
        rebind_symbols((struct rebinding[1]){{"xpc_pipe_routine",(void *)new_xpc_pipe_routine, (void **)&orig_xpc_pipe_routine}},1);
        rebind_symbols((struct rebinding[1]){{"xpc_connection_send_message",(void *)new_xpc_connection_send_message, (void **)&orig_xpc_connection_send_message}},1);
        rebind_symbols((struct rebinding[1]){{"xpc_connection_send_message_with_reply",(void *)new_xpc_connection_send_message_with_reply, (void **)&orig_xpc_connection_send_message_with_reply}},1);
        rebind_symbols((struct rebinding[1]){{"xpc_connection_send_message_with_reply_sync",(void *)new_xpc_connection_send_message_with_reply_sync, (void **)&orig_xpc_connection_send_message_with_reply_sync}},1);
        // xpc_pipe_routine
        /*
